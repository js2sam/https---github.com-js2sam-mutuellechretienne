...
(function(h) {
    ...
    function Ca(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && (d && "Pas de données dans la table" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Affiche _START_ à _END_ de _TOTAL_ éléments",
            sInfoEmpty: "Affiche 0 à 0 de 0 éléments",
            sInfoFiltered: "(filtrage sur un total de _MAX_ entrées)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
